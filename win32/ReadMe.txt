========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet NR-deckbuilder
========================================================================

AppWizard a créé cette application NR-deckbuilder pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application NR-deckbuilder.


NR-deckbuilder.vcxproj
...
NR-deckbuilder.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé NR-deckbuilder.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
